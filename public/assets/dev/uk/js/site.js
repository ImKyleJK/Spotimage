function TogglePageLoader(ToggleValue){
    const ValidToggleValue = typeof ToggleValue == "boolean" ? true : false
    if(ValidToggleValue){
        ToggleValue ? $( ".app-loader" ).hide() : $( ".app-loader" ).show()
        NewEvent('AppLog',"PageLoader Toggled")
    } else {
        NewEvent('AppError',"Invalid TogglePageLoader Value")
    }
}
